...
export default class IcarusInputList {
	 ...
	 */
	constructor(node, myValue, postElementRoute, objectLabel, objectIdName) {
	...
	getCategories(categoryId) {
		...
		let dataToBeSent = {};
		$.post(categoryElementRoute + '/' + categoryId, dataToBeSent, function(formCategoryData, textStatus) {
			var myElements = [];
			// textStatus contains the status: success, error, etc
			// If server responds with 'success'
			if (textStatus === "success") {
