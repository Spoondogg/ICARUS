...
namespace ICARUS.Controllers {
    ...
    /// </summary>
    public class WordController : ContainerController {

        public WordController() : base("WORD") {
        ...
        public override Container select(ObjectDBContext ctx, int id) {
            return ctx.Words.AsQueryable().Single(FilterById(id));
        }
        ...
        public override IEnumerable<Container> selectAll(ObjectDBContext ctx) {
            return ctx.Words.Where(FilterAllowed());
        }
    }
}